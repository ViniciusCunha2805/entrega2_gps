...
export const INITIAL_STATE = {
  ...
  products: [
    { id: 1, icon: '🧴', name: 'Pomada Matte Premium',  desc: 'Fixação forte, acabamento fosco',     price: '45,00' },
    { id: 2, icon: '🧖', name: 'Óleo de Barba',          desc: 'Hidrata e amacia, aroma amadeirado',  price: '38,00' },
    { id: 3, icon: '✂️', name: 'Shampoo Anticaspa Pro',  desc: 'Uso profissional, fragrância masc.',  price: '32,00' },
    { id: 4, icon: '💆', name: 'Cera Modeladora',         desc: 'Fixação média, brilho natural',       price: '28,00' },
    { id: 5, icon: '🪒', name: 'Gel Pós-Barba',           desc: 'Acalma a pele, evita irritação',      price: '22,00' },
  ],
